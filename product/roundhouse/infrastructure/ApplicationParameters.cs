namespace roundhouse.infrastructure
{
    ...
    public static class ApplicationParameters
    {
        ...
        public static readonly string default_roundhouse_database_type = "roundhouse.databases.sqlserver.SqlServerDatabase, roundhouse.databases.sqlserver.roundhousedb";
        ...
        public class CurrentMappings
        {
            ...
            public static string roundhouse_database_type = default_roundhouse_database_type;
        }
    }
}